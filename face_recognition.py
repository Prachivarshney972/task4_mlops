...
# Loading our actor's Dataset


from keras.preprocessing.image import ImageDataGenerator

train_data_dir = '3_actors/train/'
validation_data_dir = '3_actors/validation/'
...
checkpoint = ModelCheckpoint("actors120720.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only = True,
                             verbose=1)
...
classifier = load_model('actors120720.h5')
...
actors_dict = {"[0]": "ayushmaan khurana ", 
               "[1]": "mahesh babu",
               "[2]": "salmaan khan"}
actors_dict_n = {"ayushmaan khurana": "ayushmaan khurana ", 
                      "mahesh babu": "mahesh babu",
                      "salmaan khan": "salmaan khan"}
...
for i in range(0,10):
    input_im = getRandomImage("3_actors/validation/")
